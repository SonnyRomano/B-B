...
export default class PaginaRicerca extends Component {
    ...
    render() {
        ...
        const listItems = this.state.map((d) =>
            ...
            <a href="prova123.html" class="list-group-item list-group-item-action border border-primary " style={{ marginTop: '1rem', marginBottom: '1rem', background: '#E6E6FA'}}>
                <div class='row' >
                    <div class='col-6' key={'div' + d.idAnnuncio} style={{ marginTop: '1rem', marginBottom: '1rem'}}>
                         <img key={'img' + d.idAnnuncio} style={{ width: '100%'}} src={require('../../../images/ID' + d.idAnnuncio + '/Cover.png')} alt="CoverImage"  ></img>
                    </div>
                    <div class='col-6' style={{ marginTop: '2rem'}}>
