...
export default class PaginaRicercaProprietario extends Component {
    ...
    componentWillMount(){
        ...
        axios.post(`http://127.0.0.1:9000/gestioneAnnunci/ricercaAnnunciProprietario`, { ricercaP })
            .then(res => {
                console.log(res);
                        ...
                        <div  key={'a' + d.idAnnuncio} className="list-group-item list-group-item-action " style={{ marginTop: '1rem', marginBottom: '1rem', background: '#E6E6FA' }}>
                            <div className='row' >
                                ...
                                <div className='col-6' style={{ marginTop: '2rem' }}>
                                    ...
                                    <button onClick={() => this.handleClick(d)} type="button" class="btn btn-lg btn-danger">Modifica</button>
                                </div>
                            </div>
                        </div>
                    </li>
